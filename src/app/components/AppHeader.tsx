  ...
  return (
    <header className="bg-white border-b px-6 py-3 flex items-center justify-between">
      ...
      <div className="flex items-center gap-2">
        ...
        <Button variant="ghost" size="icon" onClick={onOpenPeople} aria-label="Open people settings">
          <User className="w-5 h-5" />
        </Button>
        <Button variant="ghost" size="icon" onClick={onOpenAgents} aria-label="Open agents settings">
