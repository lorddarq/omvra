...
description: Frame a business problem or opportunity before solutioning by separating symptoms from causes and clarifying scope, objectives, assumptions, constraints, options, and success criteria. Use when a project is starting or solution bias is obscuring the real problem.
---
