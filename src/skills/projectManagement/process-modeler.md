...
description: Specify a business process clearly enough for consistent BPMN or UML activity modeling. Use when an as-is or to-be flow needs explicit actors, tasks, decisions, handoffs, exceptions, boundaries, and outcomes.
---
